    ...
    return (
        <div className='mx-auto'>
            <section className='w-full h-full mx-auto my-auto flex flex-col items-center'>
                ...
                <Link
                    href='/home'
                    className='w-[10em] flex flex-row gap-2 no-underline text-white alight-center px-6 bg-slate-600 font-black items-center justify-center rounded-xl text-center py-4 mt-6'
                >
                    Get Started
                </Link>
            </section>
